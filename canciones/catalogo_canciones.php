...
<body>
   ...
   <div class="container-fluid">
     ...
     <table id="table_id" class="table table-bordered table-striped"> <!--Agregar un hover-->
       <h2 align="center">Canciones</h2><br>

<a  class="btn btn-secondary btn-sm" href="form_cancion.php">Nueva canción</a>
<hr>
  <thead>
	<tr>
		<th>Id</th>
...
while($row = pg_fetch_assoc($ejecucion)){
  ...
  ?>
	...
	<td><a class="btn btn-success btn-sm" href="edita_canciones.php?cancion_id= <?php echo $row['cancion_id'];?>">Editar</a></td>
	<td><a class="btn btn-danger btn-sm" href="baja_canciones.php?cancion_id= <?php echo $row['cancion_id'];?>">Borrar</a></td>
	</tr>
  <?php
      }
  ?>
